...
<body>
    <header>
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse" id="ItemToBeCollapse"> <!-- la class collapse c'est pour le style display none ou au contraire -->
                <ul>
                    <li class="nav-item ">
                    ...
                    <li class="nav-item dropdown"> <!-- dropdown pour menu deroulant  -->
                        <a class="nav-link dropdown-toggle" href="">A propos</a>
