            ...
            <div class="row justify-content-center align-items-center g-4">
                ...
                <div class="col-lg-5">
                    <div class="auth-text text-white">
                        <span class="hero-badge mb-3 d-inline-block">Créer un compte</span>
                        <h1 class="fw-bold mb-3">Rejoignez la communauté REVIEWEO</h1>
                        <p class="mb-0 text-white-50">
                            Créez votre compte pour publier vos critiques, découvrir de nouveaux livres
                            et interagir avec les autres lecteurs.
                        </p>
                    </div>
                </div>
